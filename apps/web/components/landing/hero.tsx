      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="mb-6 text-4xl font-bold tracking-tight text-balance md:text-5xl lg:text-6xl">
            Store everything.
            <br />
            <span className="text-primary">Pay almost nothing.</span>
          </h1>
          <p className="mb-10 text-lg text-muted-foreground text-balance md:text-xl">
            Nexus is deep storage that just works. Get the reliability of AWS Glacier without the complexity — for just
            $1/TB/month.
          </p>
