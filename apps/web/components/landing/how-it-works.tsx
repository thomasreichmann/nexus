...
const steps = [
  {
    icon: Upload,
    title: "Upload",
    description: "Drag and drop your files. We accept any file type, any size.",
  },
  {
    icon: Database,
    title: "We archive",
    description: "Your files are automatically stored in AWS Glacier with 11 nines durability.",
  },
  {
    icon: Download,
    title: "Retrieve",
    ...
    <section id="how-it-works" className="py-20 md:py-28">
      <div className="container mx-auto px-4">
        <div className="mx-auto mb-16 max-w-2xl text-center">
          ...
          <p className="text-lg text-muted-foreground">Three simple steps to secure, affordable storage.</p>
        </div>
