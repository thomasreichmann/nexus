      ...
      <Card>
        <CardContent className="flex flex-col items-center justify-center py-16">
          ...
          <p className="mb-4 text-center text-muted-foreground">
            Upload your first files to get started with deep storage.
          </p>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>
                  <Button variant="ghost" className="-ml-4 h-8" onClick={() => toggleSort("name")}>
                    Name
                    <ArrowUpDown className="ml-2 h-4 w-4" />
                  </Button>
                </TableHead>
                <TableHead>
                  <Button variant="ghost" className="-ml-4 h-8" onClick={() => toggleSort("size")}>
                    Size
                    <ArrowUpDown className="ml-2 h-4 w-4" />
                  </Button>
                </TableHead>
                <TableHead>
                  <Button variant="ghost" className="-ml-4 h-8" onClick={() => toggleSort("uploadedAt")}>
                    Uploaded
                    <ArrowUpDown className="ml-2 h-4 w-4" />
                  </Button>
                </TableHead>
          ...
          {sortedFiles.map((file) => (
            <Card key={file.id} className="group relative">
              <CardContent className="p-4">
                ...
                <p className="mb-2 text-sm text-muted-foreground">{file.size}</p>
