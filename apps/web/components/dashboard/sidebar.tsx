...
import { Archive, LayoutDashboard, FolderOpen, Upload, Settings } from "lucide-react"
    ...
    <aside className="hidden w-64 flex-col border-r border-border bg-sidebar md:flex">
      ...
      <div className="border-t border-sidebar-border p-4">
        <div className="rounded-lg bg-sidebar-accent/50 p-4">
          <p className="text-xs font-medium text-sidebar-foreground">Storage used</p>
          <div className="mt-2 h-2 overflow-hidden rounded-full bg-sidebar-border">
            <div className="h-full w-1/3 rounded-full bg-primary" />
          </div>
          <p className="mt-2 text-xs text-muted-foreground">34.2 GB of 100 GB</p>
        </div>
      </div>
    </aside>
  )
