...
var Lr = (function () {
    ...
    return (
        ...
        (n.prototype.addMessageForTextRange = function (e, t, r) {
            this.addMessage(
                new hn({ messageId: e, messageText: t, textRange: r })
            );
        }),
    ...
    return (
        (n.readTokens = function (e) {
            ...
            return (
                r
                    ? t.push(
                          new Pt(u.EndOfInput, r.getNewRange(r.end, r.end), r)
                      )
            ...
            for (
                ...
                (d === void 0 && (d = u.Other),
                    (a !== void 0 && d === a && n._isMultiCharacterToken(a)) ||
                        (a !== void 0 &&
                            e.push(new Pt(a, t.getNewRange(l, o), t)),
                        (l = o),
                        (a = d)),
                    ++o);
            }
            ...
            for (var m = !1; !m; )
                switch (e.peekTokenKind()) {
                    ...
                    case u.Backslash:
                        if (
                            (e.readToken(),
                            !An.isPunctuation(e.peekTokenKind()))
                        ) {
    ...
    if (!!F) {
        ...
        if (l) {
            var Mn,
                ...
                se =
                    b && cn ? ho(qn, rt, Ge) : qt(b ? qn : In, rt, b ? Ge : Fn);
            ((F[H] = se), (C[H] = se - rt));
        }
        e.modifiersData[r] = C;
    }
...
function zs() {
    ...
    return (
        ...
        (n.wbg.__wbindgen_string_get = function (e, t) {
            ...
            var o = Us(i)
                    ? 0
                    : mt(i, M.__wbindgen_malloc, M.__wbindgen_realloc),
                a = Re;
...
var ta = X(require('@codemirror/language')),
    ...
    Ii = class {
        ...
        desktopShouldHighlight() {
            return (
                Mi.Platform.isDesktopApp &&
                this.plugin.settings.syntax_highlighting
            );
        }
        mobileShouldHighlight() {
            return (
                Mi.Platform.isMobile &&
                this.plugin.settings.syntax_highlighting_mobile
            );
        }
        async setup() {
